...
import net.autogroup.turbodns.sys.QueryTracker;
import net.autogroup.turbodns.ui.settings.ServerChooser;
import net.autogroup.turbodns.ui.settings.SettingsFragment;
...
import net.autogroup.turbodns.sys.Names;
import net.autogroup.turbodns.sys.PersistentState;
import net.autogroup.turbodns.sys.VpnController;
import net.autogroup.turbodns.sys.VpnState;
...
public class MainActivity extends AppCompatActivity
      ...
      public boolean onNavigationItemSelected(MenuItem item) {
        switch (item.getItemId()) {
          ...
          case R.id.source_code:
            openUrl("https://github.com/adaramuju/Turbodns");
            return true;
          default:
            return false;
        }
  ...
  public void onBackPressed() {
    if (isShowingHomeView()) {
      // Back button should leave the net if we are currently looking at the home view.
      super.onBackPressed();
      return;
    }
    chooseView(R.id.frame_main);
