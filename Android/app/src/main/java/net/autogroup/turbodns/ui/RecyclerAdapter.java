...
*/
package net.autogroup.turbodns.ui;
...
import net.autogroup.turbodns.net.dns.DnsPacket;
...
/**
 * The main screen of the net is implemented as a Recycler, allowing quasi-infinite scrolling.
...
public class RecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
  ...
  private final class Transaction {
    ...
    Transaction(@NonNull net.autogroup.turbodns.net.doh.Transaction transaction) {
      ...
      if (transaction.status == net.autogroup.turbodns.net.doh.Transaction.Status.COMPLETE) {
        ...
        if (transaction.status == net.autogroup.turbodns.net.doh.Transaction.Status.CANCELED) {
          flag = "\u274c";  // "X" mark
        } else {
          flag = "\u26a0";  // Warning sign
        }
   ...
   */
  public void reset(Queue<net.autogroup.turbodns.net.doh.Transaction> transactions) {
    this.transactions.clear();
    if (transactions != null) {
      for (net.autogroup.turbodns.net.doh.Transaction t : transactions) {
   ...
   */
  public void add(net.autogroup.turbodns.net.doh.Transaction transaction) {
